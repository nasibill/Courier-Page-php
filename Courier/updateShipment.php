...
<body>
	...
	<h1 class='center'>Update Shipment</h1>
...
if(isset($_POST['submit'])) { 
		...
		$query = "UPDATE shipment SET date= '$date', deliveryDate= '$deliveryDate', type='$type', weight='$weight', dimensions='$dimensions',deliveryAddress='$deliveryAddress',
